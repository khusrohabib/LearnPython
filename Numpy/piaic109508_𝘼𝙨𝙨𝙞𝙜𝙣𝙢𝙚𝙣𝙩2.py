...
def function6():
    ...
    arr = arr = ((np.arange(5,55,5) // 2 == 10 ) | ( np.arange(5,55,5) // 2 == 20 )).astype(int) * np.arange(5,55,5) // 2 #wrtie your code here
...
def function7():
    ...
    return np.zeros(x.shape) #write your code here
...
def function8():
    ...
    x = np.ones(10, dtype=int).reshape(2,5) * 6 #write your code here
...
def function11():
    ...
    ans = [x if x % 2 == 0 else -1 for x in arr]
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.hstack((np.ones(3,dtype=int),np.ones(3,dtype=int)*2,np.ones(3,dtype=int)*3,arr,arr,arr)) #write your code here x
...
def function14():
    ...
    ans = np.split(arr.reshape(8,3),4,axis=0) #write your code here 
...
def function17():
    ...
    return ['YES' if x % 3 == 0 & x % 5 ==0 else 'NO' for x in arr]
...
def function18():
    ...
    x =  len(students[[True if y in piaic else False for y in students]])
    return x
